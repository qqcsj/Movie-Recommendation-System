...
urlpatterns = [
    ...
    path('content_recommend/<int:movie_id>', views.content_recommend),
    path('ai_search/', views.ai_search),
    ...
    path('draw_movie', views.draw_movie_api, name='draw_movie_api'),
    path('vote/list', views.get_vote_characters),
    path('vote/action', views.vote_character),
    path('vote/stats', views.get_vote_statistics_chart, name='vote_stats'),
